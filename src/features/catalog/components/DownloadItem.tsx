...
const DownloadItem: React.FC<DownloadItemProps> = ({data}) => {
  return (
    <li className='flex flex-grow flex-col overflow-hidden border border-gray-200 bg-white shadow-md transition hover:shadow-lg'>
      ...
      <div className='flex flex-shrink-0 items-center justify-between bg-gray-100 px-6 py-4'>
