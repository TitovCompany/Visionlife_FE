      ...
      <article ref={ref} className="max-w-6xl">
        ...
        <ul className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {comparison.items[0].steps.map((step, idx) => (
            <div
              key={step.id}
              className="biz_item flex items-center gap-6 rounded-lg bg-white p-6 shadow-md">
              <img
      ...
      <article ref={ref} className="max-w-6xl pt-20">
        ...
        <ul className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {comparison.items[1].steps.map((step) => (
            <div
              key={step.id}
              className="biz_item bg-primary-50 border-primary flex items-center gap-6 rounded-lg border p-6 shadow-md">
              <img
