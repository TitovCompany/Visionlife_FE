  ...
  return (
   <>
    ...
    <div className={clsx('hidden')}>
     <ul>
      <li><Link to='/'><span>ECO-FRIENDLY INNOVATION</span></Link></li>
      <li><Link to='/'><span>INK TECHNOLOGY</span></Link></li>
      <li><Link to='/'><span>SUSTAINABLE MANUFACTURING</span></Link></li>
      <li><Link to='/'><span>PARTNERSHIP & GROWTH</span></Link></li>
     </ul>
    </div>
    <div className={clsx('hidden')}>
     ...
     <ul>
      <li>
       <span>01</span>
       <h3>지속 가능한 친환경 기술</h3>
       <p>비전라이프는 무폐수 디지털 나염을 통해
        <strong>80% 물 절감 & 탄소 배출 50% 감소</strong>를 실현합니다.
        친환경 공정으로 지속 가능한 섬유 산업을 선도합니다.</p>
      </li>
      <li>
       <span>02</span>
       <h3>친환경 인증 & 글로벌 기준 준수</h3>
       <p>OEKO-TEX®, GOTS 등 <strong>국제 친환경 인증</strong>을 획득하여,
        글로벌 시장에서도 신뢰할 수 있는 품질을 제공합니다.</p>
      </li>
      <li>
       <span>03</span>
       <h3>Title</h3>
     ...
     <ul>
      <li>
       ...
       <p className="text-lg text-gray-700 leading-relaxed mt-2">
        <strong>N-RECT 친환경 수성 잉크</strong>는
        기존 잉크보다 더 선명한 색감과 뛰어난 내구성을 제공합니다.
       </p>
      </li>
      <li>
     ...
     <ul>
      <li>
       ...
       <p className="text-lg text-gray-700 leading-relaxed mt-2">
        전처리 & 후처리 과정이 필요 없는
        <strong>효율적인 디지털 나염 공정</strong>으로
        생산 비용과 에너지를 절감할 수 있습니다.
       </p>
      </li>
      <li>
       <span className="text-3xl font-bold text-primary">02</span>
     ...
     <ul>
      <li>
       ...
       <p className="text-lg text-gray-700 leading-relaxed mt-2">
        비전라이프는 <strong>B2B 파트너십</strong>을 통해
        기업의 지속 가능한 성장과 브랜드 가치를 높이고 있습니다.
       </p>
      </li>
      <li>
       <span className="text-3xl font-bold text-primary">02</span>
