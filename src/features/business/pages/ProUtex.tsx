  ...
  <GridLayout>
   ...
   <GridArticle className='relative'>
    <video
     ...
     playsInline
    />
    <h2 className='absolute top-1/2 left-1/2 w-full max-w-5xl -translate-1/2 pb-4 text-center text-2xl leading-normal font-bold text-white md:pb-8 md:text-7xl'>
     비전라이프의 PROUTEX
     <br />
     친환경 섬유 염색 솔루션
    </h2>
   ...
   <GridArticle colStart={6} colEnd={12} className='flex flex-col items-center justify-center'>
    <div>
   ...
   <GridArticle colStart={2} colEnd={6} className='flex flex-col items-center justify-center'>
    원단불문 나일론 가능
   </GridArticle>
   ...
   <GridArticle colStart={7} colEnd={12} className='mt-8 gap-6 flex flex-col'>
