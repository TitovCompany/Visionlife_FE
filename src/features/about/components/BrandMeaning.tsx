...
const BrandMeaning = () => {
 return (
  <GridLayout>
   {/* Brand Meaning */}
   <GridArticle colStart={1} colEnd={13} className={clsx('mt-10 md:mt-32 mb-10 md:mb-20 text-left px-4 md:px-0 md:col-start-2 md:col-end-7')}>
    <h2 className='text-3xl md:text-7xl font-bold'>Brand Meaning</h2>
    <p className='mt-6 md:mt-10 text-base md:text-xl leading-7 md:leading-8'>
     Vision Life는 단순한 제품을 넘어, 지속 가능한 기술과 혁신을 바탕으로 환경과 조화를 이루는 제품을 개발하는 브랜드입니다. 우리는 친환경적인 솔루션을 통해 지속 가능한 미래를 창조하는 것을 목표로 합니다.
    </p>
    <p className='mt-4 md:mt-6 text-base md:text-xl leading-7 md:leading-8'>
   ...
   {/* Color */}
   <GridArticle colStart={1} colEnd={13} className={clsx('mb-16 md:mb-32 w-full mt-6 md:mt-10 content-center px-4 md:px-0 md:col-start-2 md:col-end-7')}>    <ul className='flex flex-col gap-6 md:gap-10'>
