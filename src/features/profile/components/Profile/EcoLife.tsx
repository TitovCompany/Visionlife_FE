...
const EcoLife = () => {
 return (
  <section className={clsx('relative text-center', 'grid grid-cols-12',)}>
   {/* 메인 타이틀 */}
   <article className={clsx('text-primary mt-10 p-6', 'col-span-12 lg:col-span-10 lg:col-start-3')}>
    <h2 className="text-primary text-5xl font-bold">
     비전라이프의 기술이 만드는 ECO Life
    </h2>
    <p className="text-primary text-left text-xl max-w-2xl mt-4 leading-relaxed">
   ...
   {/* 환경 보호 효과 */}
   <article className={clsx('text-primary w-2/3 mt-10 p-6 ', 'col-span-12 lg:col-span-10 lg:col-start-3')}>
