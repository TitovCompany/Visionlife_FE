const CEO = () => {
 return (
  <>
   <section className='mx-auto h-full max-w-7xl px-6 py-20 lg:px-12'>
    <h2 className='text-3xl font-bold text-gray-900'>
     대표이사 <span className='text-primary'>차무현</span>
    </h2>
    <article className='flex h-full w-full flex-col items-center justify-center gap-10 md:flex-row'>
     {/* CEO 이미지 */}
